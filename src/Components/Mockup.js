          ...
          <div className="section">
            ...
            <ul className="benefits">
              <li className="pillar">
                ...
                <p>
                  <span className="a">Research</span> has shown that adding a
                  signature color to your branding can increase brand
                  recognition by 80%, compared to designs done in grayscale.
                </p>
              </li>
              <li className="pillar">
                <div className="icon">
                ...
                <p>
                  ...
                  instantaneously. The <span className="a">feelings</span>{" "}
              ...
              <li className="pillar">
                ...
                <p>
                  ...
                  and guide the user’s <span className="a">attention</span>{" "}
